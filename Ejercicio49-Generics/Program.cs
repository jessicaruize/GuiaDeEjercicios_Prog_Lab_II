...
namespace Ejercicio49_Generics
{
    class Program
    {
        ...
        {
            Competencia<AutoF1> cF = new Competencia<AutoF1>(10, 5, Competencia<AutoF1>.TipoCompetencia.F1);
            Competencia<MotoCross> cM = new Competencia<MotoCross>(15, 2, Competencia<MotoCross>.TipoCompetencia.MotoCross);
            ...
            //}
            Console.WriteLine(cF + new AutoF1(12, "ADS23")); //No se debe agregar
            Console.WriteLine(cM + new MotoCross(11, "RSD23")); // No se debe agregar
