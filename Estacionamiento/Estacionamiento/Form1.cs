...
using EstacionamientoLogica;

namespace EstacionamientoVista
{
    public partial class FormEstacionamiento : Form
    {
        EstacionamientoLogica.Estacionamiento estacionamiento;
        ...
        private void FormEstacionamiento_Load(object sender, EventArgs e)
        {
            ...
            this.estacionamiento = EstacionamientoLogica.Estacionamiento.GetEstacionamiento("Jessica Ruiz",
            20);
